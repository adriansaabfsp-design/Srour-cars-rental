  ...
  if (!car) {
    return (
      <div className="flex min-h-screen flex-col items-center justify-center bg-luxury-black">
        ...
        <Link
          href="/"
          className="mt-8 border border-gold bg-transparent px-10 py-3.5 text-[12px] font-bold uppercase tracking-[0.2em] text-gold transition-all duration-300 hover:bg-gold hover:text-black"
        >
