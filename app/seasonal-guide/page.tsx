    ...
    <div className="relative overflow-hidden border border-luxury-border bg-luxury-card">
      ...
      <div className="relative flex flex-col lg:flex-row">
        ...
        <div className={"flex-1 px-6 py-8 sm:px-10 sm:py-10 " + (!isEven ? "lg:order-1" : "")}>
          {/* weather */}
          <div className="mb-6">
            <p className="mb-1 text-[10px] font-bold uppercase tracking-[0.3em] text-gold/50">Weather</p>
            <p className="text-sm leading-relaxed text-white/50">{season.weather}</p>
          </div>

          {/* destinations */}
          <div className="mb-6">
            <p className="mb-2 text-[10px] font-bold uppercase tracking-[0.3em] text-gold/50">
              Best Destinations
            </p>
            <div className="flex flex-wrap gap-2">
              {season.destinations.map((d) => (
                <span
                  key={d}
                  className="border border-gold/15 bg-gold/5 px-3 py-1.5 text-[11px] font-medium text-gold/80"
                >
                  {d}
                </span>
              ))}
          ...
          <div className="mb-6 flex flex-wrap items-center gap-3">
            <p className="text-[10px] font-bold uppercase tracking-[0.3em] text-gold/50">
              Recommended Car:
            </p>
            <span className="text-sm font-semibold text-white/70">{season.recommendedCar}</span>
            <a
              href="/#collection"
              className="ml-auto border border-gold/30 px-4 py-2 text-[10px] font-bold uppercase tracking-[0.2em] text-gold transition-all hover:bg-gold hover:text-black"
            >
              View Fleet →
            </a>
          </div>
    ...
    <button
      ...
      className={
        ...
        (active
          ...
          : "border-luxury-border bg-luxury-card text-white/50 hover:border-gold/30 hover:text-white")
      }
    >
      {label}
    </button>
              ...
              <thead>
                <tr className="border-b border-luxury-border">
                  {["Month", "Weather", "Crowds", "Prices", "Best Activity"].map((h) => (
                    <th
                      key={h}
                      className="px-4 py-3 text-left text-[10px] font-bold uppercase tracking-[0.25em] text-gold/50"
                    >
                      {h}
                    </th>
                  ))}
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-4 py-3.5">
                        <WIcon className="h-5 w-5 text-gold/60" />
                      </td>
      ...
      <section className="border-t border-luxury-border">
        <div className="mx-auto max-w-3xl px-4 py-14 sm:px-6 sm:py-20">
          ...
          <div className="space-y-8">
            ...
            {/* result */}
            {recommendation && (
              <div className="border border-gold/30 bg-gold/5 p-6 text-center sm:p-8">
                <p className="text-[10px] font-bold uppercase tracking-[0.3em] text-gold/60">
                  We recommend
                </p>
                <p className="mt-3 font-serif text-2xl font-bold text-gold sm:text-3xl">
                  {recommendation}
                </p>
                ...
                <a
                  href="/#collection"
                  className="mt-6 inline-block bg-gold px-8 py-3 text-[11px] font-bold uppercase tracking-[0.2em] text-black transition-all hover:bg-gold-light"
                >
                  View Fleet →
                </a>
              </div>
