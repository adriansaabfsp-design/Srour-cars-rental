    ...
    <div>
      ...
      <div className="relative aspect-[16/10] w-full overflow-hidden border border-luxury-border bg-black">
        ...
        {videoUrl && onPlayVideo && (
          ...
          >
            <div className="flex h-20 w-20 items-center justify-center border-2 border-white/30 bg-black/60 backdrop-blur-sm transition-all duration-300 group-hover:border-gold group-hover:bg-black/80 group-hover:scale-110">
              <svg className="h-8 w-8 text-white ml-1 transition-colors group-hover:text-gold" fill="currentColor" viewBox="0 0 24 24">
                <path d="M8 5v14l11-7z" />
              </svg>
            </div>
            <span className="mt-2 block text-center text-[10px] font-bold uppercase tracking-[0.2em] text-white/60 group-hover:text-gold transition-colors">
              Play Video
            </span>
          </button>
        )}
        ...
        {photoList.length > 1 && (
          <>
            <button
              onClick={goPrev}
              className="absolute left-3 top-1/2 z-10 -translate-y-1/2 border border-white/10 bg-black/70 p-3 backdrop-blur-sm transition-all hover:border-gold/30 hover:bg-black/90"
            >
            ...
            <button
              onClick={goNext}
              className="absolute right-3 top-1/2 z-10 -translate-y-1/2 border border-white/10 bg-black/70 p-3 backdrop-blur-sm transition-all hover:border-gold/30 hover:bg-black/90"
            >
              <svg className="h-4 w-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            return (
              <button
                ...
                className={`group relative aspect-[4/3] overflow-hidden border transition-all duration-300 ${
                  isActive
                    ? "border-gold opacity-100 gold-glow"
