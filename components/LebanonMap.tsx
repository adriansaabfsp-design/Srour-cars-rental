...
const destinations: Destination[] = [
  ...
  { id: 5, name: "Tripoli", lat: 34.4361, lng: 35.8498, x: 493.9, y: 175, distance: "85km", time: "~1.5hrs", car: "Sedan", desc: "Souks, citadels, and the best street food in the country", tags: ["Culture", "Food"], season: "Year-round" },
