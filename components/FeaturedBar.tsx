          ...
          >
            ...
            <div className="relative aspect-[16/9] w-full overflow-hidden bg-white">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-4">
                <div className="mb-1 text-[9px] font-medium uppercase tracking-[0.3em] text-white/40">
                  {car.brand}
                </div>
            ...
            <div className="absolute top-1/2 right-3 -translate-y-1/2 opacity-0 transition-all duration-300 group-hover:opacity-100 group-hover:translate-x-0 translate-x-2">
              <div className="flex h-8 w-8 items-center justify-center bg-black/50 backdrop-blur-sm">
