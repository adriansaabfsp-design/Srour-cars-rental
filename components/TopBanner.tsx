...
export default function TopBanner() {
  ...
  return (
    <div className="relative z-50 flex items-center justify-center border-b border-navy-light bg-navy px-4 py-2 text-center">
      ...
      <div className="absolute left-3 top-1/2 -translate-y-1/2 hidden items-center gap-2.5 sm:flex">
        <a href="https://www.instagram.com/lebanon.rental" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-white/70 transition-colors hover:text-white">
        ...
        <a href="https://www.facebook.com/share/1AidWBciia/" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="text-white/70 transition-colors hover:text-white">
        ...
        <a href="https://www.tiktok.com/@lebanon.rental" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="text-white/70 transition-colors hover:text-white">
      ...
      <button
        ...
        className="absolute right-2 top-1/2 -translate-y-1/2 flex h-5 w-5 items-center justify-center text-white/70 transition-colors hover:text-white sm:right-4"
