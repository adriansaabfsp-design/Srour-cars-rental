...
export default function TopBanner() {
  ...
  return (
    <div className="relative z-50 flex items-center justify-center bg-gradient-to-r from-gold via-gold-light to-gold px-4 py-2 text-center">
      {/* Social icons — left side */}
      <div className="absolute left-3 top-1/2 -translate-y-1/2 hidden items-center gap-2.5 sm:flex">
        <a href="https://www.instagram.com/lebanon.rental" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-black/40 transition-colors hover:text-black">
        ...
        <a href="https://www.facebook.com/share/1AidWBciia/" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="text-black/40 transition-colors hover:text-black">
        ...
        <a href="https://www.tiktok.com/@lebanon.rental" target="_blank" rel="noopener noreferrer" aria-label="TikTok" className="text-black/40 transition-colors hover:text-black">
